    ...
    <div class="col-md-6 col-xl-3">
        <div class="card item-card" style="height: 450px">
            <div class="ribbone z-index2">
                <div class="ribbon"><span>Ditolak</span></div>
            </div>
            <div class="product-grid6 card-body">
                ...
                <ul class="icons z-index3" style="background: rgb(0,0,0); background: linear-gradient(180deg, rgba(0,0,0,0) 0%, rgba(0,0,0,0.65) 15%, rgba(0,0,0,0.75) 25%, rgba(0,0,0,1) 100%);
                    ...
                    <div class="container">
                        ...
                        <a href="fotomasalah" class="btn btn-secondary w-90 fotoKecuranganditolak mt-2 rounded-0" id="Cek"
                            data-bs-toggle="modal" id="" data-bs-target="#fotoKecuranganditolak" data-id="{{$ls->tps_id}}">
                            List Kecurangan</a>
                    </div>
                </ul>
            </div>
