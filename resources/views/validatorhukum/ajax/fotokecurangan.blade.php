<div class="row">
    <div class="col-lg-12">
        <center>
            <h1>Laporan Kecurangan Saksi</h1>
        </center>
    </div>
    <div class="col-md-6">
            ...
            <div class="col-md">
                ...
                <div class="card" style="width: 100%; height: auto;">
                    <div class="card-header">
                        <h3 class="card-title">Foto Kecurangan</h3>
                    </div>
        ...
        <div class="row">
            <div class="col-md">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Vidio Kecurangan</h4>
                    </div>
                    <div class="card-body">
                        <p class="card-text">
        ...
        <div class="card">
            ...
            <form action="action/proses_kecurangan/{{ Crypt::encrypt($tps['id']); }}"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="2"><textarea name="kecurangan"
                                            placeholder="catatan hukum" class="form-control"
                ...
                <div class="card-footer">
                    ...
                    <a href="action_verifikasi_kecurangan/{{ Crypt::encrypt($tps['id']); }}" class="btn mt-2 ml-3 btn-success">Verifikasi Kecurangan</a>
                    {{-- <a href="print/{{ Crypt::encrypt($tps['id']); }}" class="btn mt-2 ml-3 btn-success">Print Kecurangan</a> --}}
                    <?php else :?>
                    <button type="submit" class="btn btn-success">Proses Dan Download Kecurangan</button>
