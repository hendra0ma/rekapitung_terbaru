...
<div class="page">
    <div class="page-main">
            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{url('')}}/administrator/maps_count" class="slide-item">Map Count</a></li>
                    </ul>
                </li>
        ...
        <div class="modal fade" style="background-image: url({{url('')}}/storage/satelit.jpg); background-repeat: no-repeat;
                background-size: cover;" id="modalCommander" tabindex="-1" aria-labelledby="modalCommanderLabel" aria-hidden="true">
                    ...
                    <div class="modal-header">
                        <div class="row w-100 justify-content-end  align-items-center">
                            <div class="col-md">
                                ...
                                <span><img src="{{url('')}}/public/storage/alien.png" style="width:100px" alt=""> <b class="text-white fs-3" style="margin-left: -20px;">COMMANDER CODE</b></span>
                            </div>
                            <div class="col-md-5">
                                <b class="text-white fs-5 d-flex justify-content-end align-items-center my-auto align-self-center" id="modalCommanderLabel"></b>
                            </div>
                        </div>
