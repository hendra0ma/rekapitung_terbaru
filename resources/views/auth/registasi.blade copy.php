    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <select class="block mt-1 w-full" name="kecamatan" id="kecamatan">
            ...
            <div class="mt-4">
                <label for="category" class="form-label">Kelurahan</label>
                <select class="block mt-1 w-full" name="kelurahan" id="kelurahan">
                            ...
                            success: function(data) {
                                if (data) {
                                    ...
                                    $.each(data, function(key, course) {
                                        $('select[name="kelurahan"]').append('<option value="' +  course.id + '">' + course.name + '</option>');
                                    });
                                } else {
                                    $('#kelurahan').empty();
                                }
